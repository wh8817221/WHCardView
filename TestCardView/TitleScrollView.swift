...
class TitleScrollView: UIView, UIScrollViewDelegate {
    ...
    fileprivate var offset: CGFloat {
        return (configue.cardMarginX+configue.cardOffsetX)*2-configue.cardMargin
    }
...
//        self.buildUI()
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        let width =
            self.widthInfor(offsetX: scrollView.contentOffset.x)-buttonMargin
    ...
    fileprivate func widthInfor(offsetX:CGFloat) -> CGFloat {
        ...
        var index = Int(offsetX*1.999/(self.frame.width-offset))
